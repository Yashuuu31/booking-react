...
import { getBooking, storeBooking, updateBooking } from "../../api/booking";
...
const Edit = () => {
  ...
  const fetchBooking = () => {
    getBooking(params.id, {
      ...
      .then((res) => {
        setBooking(res.data);
        setCurrentSlot(res?.data?.time_slot)
      })
      .catch((error) => {
  ...
  const handleSubmit = (values) => {
    ...
    updateBooking(params.id, values)
      .then((res) => {
  ...
  const initFormValues = {
    ...
    description: booking?.customer_description,
